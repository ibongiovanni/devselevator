...
printLog("t= %2.2f\t",t);
switch(est){
	case 0: { h = h + vc*sigma; sigma = vc*altPiso; printLog("ASCENSOR: voy a seguir subiendo"); break; }
	case 1: { h = h - vc*sigma; sigma = vc*altPiso; printLog("ASCENSOR: voy a seguir bajando"); break;}
